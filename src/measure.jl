...
function apply!(s::QMeasure, state::AbstractMPS; trunc::TruncationScheme=DefaultMPSTruncation)
	pos = s.position
	if s.keep
...
measure!(state::AbstractMPS, pos::Int; keep::Bool=true, auto_reset::Bool=true, trunc::TruncationScheme=DefaultMPSTruncation) = apply!(
